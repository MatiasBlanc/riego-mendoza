...
export default function SobreMi() {
  return (
    <section
      id="sobre-mi"
      className="pt-12 pb-20 lg:pt-16 lg:pb-28 bg-crema"
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <header className="text-center mb-12">
            <p className="eyebrow justify-center">Sobre mí</p>
            <h2
              id="sobre-mi-heading"
              className="font-heading text-4xl md:text-5xl font-bold text-musgo mt-4"
            >
              Luis Matías Blanc
            </h2>
          ...
          <div className="grid md:grid-cols-5 gap-10 items-start">
            ...
            <div className="md:col-span-3 space-y-6">
              <p className="font-body text-tinta text-base leading-relaxed">
                Soy ingeniero agrónomo recibido en la UNCuyo y desde hace años
                me dedico a algo que me apasiona: que el agua llegue donde tiene
                que llegar, de la forma más eficiente posible.
              </p>
              <p className="font-body text-tinta text-base leading-relaxed">
                Empecé Riego Mendoza porque vi que muchas personas necesitaban
                sistemas de riego inteligentes pero no sabían a dónde recurrir.
                No se trata solo de instalar caños y goteros; se trata de
                entender cada espacio, cada planta, cada necesidad particular.
              </p>
              <p className="font-body text-tinta text-base leading-relaxed">
                Trabajo con todo: desde fincas y chacras hasta balcones y
                terrazas. Lo que importa no es el tamaño del proyecto, sino que
                funcione bien y que el agua se use con criterio.
              </p>

              {/* Datos rápidos */}
              <div className="flex flex-wrap gap-6 pt-4 border-t border-crema-2">
                <div>
                  <p className="font-heading text-2xl font-bold text-musgo">
                    +50
                  </p>
